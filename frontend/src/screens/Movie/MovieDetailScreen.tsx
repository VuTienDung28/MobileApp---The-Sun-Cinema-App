...
const getImageUrl = (url: string) => {
  ...
  const baseUrl = process.env.EXPO_PUBLIC_BASE_IP
...
const MovieDetailScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const handleBooking = () => {
    ...
    navigation.navigate('MovieBooking', {
      movieId: movieId,
      movieTitle: movie.title,
      movieName: movie.title,
      age: movie.ageRestriction || 'P',
      type: movie.language || '2D Phụ Đề Việt',
      ...
      >
        <View style={styles.header}>
          <Image
            source={{
              uri: getImageUrl(
                movie.backdropPosterUrl || movie.thumbnailPosterUrl
              ),
            }}
            ...
            <View style={styles.mainInfo}>
              ...
              <View style={styles.tagRow}>
                <View style={styles.tag}>
                  <Text style={styles.tagText}>4DX</Text>
                </View>

                <View style={styles.tag}>
                  <Text style={styles.tagText}>STARIUM</Text>
                </View>
              </View>
