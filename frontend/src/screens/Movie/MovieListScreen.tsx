...
const formatDate = (dateString: string) => {
  ...
  return `${date.getDate()} Thg ${months[date.getMonth()]
    }, ${date.getFullYear()}`;
};
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.metaRow}>
          ...
          <View
            style={[
              styles.ageBadge,
              {
                backgroundColor: getAgeColor(item.ageRestriction),
              },
            ]}
          >
        ...
        <View style={styles.techRow}>
          <View style={styles.techTag}>
            <Text style={styles.techText}>4DX</Text>
          </View>

          <View style={styles.techTag}>
            <Text style={[styles.techText, { color: '#D29A1D' }]}>
              STARIUM
            </Text>
          </View>
          ...
          {item.duration > 100 && (
            <View style={styles.techTag}>
              <Text style={styles.techText}>ULTRA 4DX</Text>
            </View>
          )}
        </View>
      </View>
